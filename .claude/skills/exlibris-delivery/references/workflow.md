...
- Follow Gitflow: `feature/<area>-<intent>`, `fix/<area>-<intent>`, `hotfix/<area>-<intent>`, `release/<version>`, `docs/<area>-<intent>`, `refactor/<area>-<intent>`, `test/<area>-<intent>`, or `chore/<area>-<intent>`.
- Branch from `develop`, except `hotfix/*`, which branches from `main`.
